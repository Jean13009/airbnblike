 ...
 */
final class Version20190109125139 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE message (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, messages_recus_id INT DEFAULT NULL, created_at DATETIME NOT NULL, contenu LONGTEXT NOT NULL, sup_par_exp TINYINT(1) DEFAULT NULL, sup_par_dest TINYINT(1) DEFAULT NULL, lu TINYINT(1) DEFAULT NULL, INDEX IDX_B6BD307FA76ED395 (user_id), INDEX IDX_B6BD307F1C198BD5 (messages_recus_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE message ADD CONSTRAINT FK_B6BD307F1C198BD5 FOREIGN KEY (messages_recus_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE message DROP FOREIGN KEY FK_B6BD307F1C198BD5');
